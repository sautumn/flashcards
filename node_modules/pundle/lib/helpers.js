...
exports.getResolveError = getResolveError;
...
function getResolveError(moduleName) {
  var error = new Error('Unable to resolve \'' + moduleName + '\' from root directory. Make sure it\'s installed correctly');
